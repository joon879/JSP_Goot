...
import bowl.controller.bmember.JoinController;
import bowl.controller.bmember.JoinProcController;
import bowl.controller.bmember.LoginController;
import bowl.controller.bmember.LoginProcController;
import bowl.controller.bmember.LogoutProcController;
...
//		NoticeEditController controller2 = new NoticeEditController();
		...
		try {
			...
			}else if(com.equals("/joinus/joinProc.do")) {
